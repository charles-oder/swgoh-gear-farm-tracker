...
describe('Observable', () => {
    it('invokes callback on observe', () => {
        ...
        testObject.observe('id', (newValue, oldValue) => value = newValue);
    ...
    it('invokes all observers on change', () => {
        ...
        testObject.observe('id', (newValue, oldValue) => value1 = newValue);
        testObject.observe('id-2', (newValue, oldValue) => value2 = newValue);
        value1 = 'nothing';
        value2 = 'nothing';
        testObject.value = 'banana';
